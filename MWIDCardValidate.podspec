...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Murphy"
  # s.authors            = { "Murphy" => "tinynorth@163.com" }
  # s.social_media_url   = "http://twitter.com/Murphy"
  ...
  s.source       = { :git => "http://EXAMPLE/MWIDCardValidate.git", :tag => "1.0.0" }
